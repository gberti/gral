#ifndef GRAL_GB_COMPLEX2D_CONSTRUCT_C
#define GRAL_GB_COMPLEX2D_CONSTRUCT_C
...

{
  ...
  // setup archetype info if G_src has no archetypes, assuming linearly ordered polygons.
