...
/*  Specialization of partial grid morphism for 1D case.
*/

template<class GDEF, class GIMG>
class partial_grid_morphism_aux<GDEF,GIMG,grid_dim_tag<1> >
{
  typedef partial_grid_morphism_aux<GDEF,GIMG,grid_dim_tag<1> > self;
public:
...
public:
  ...
  */
  ...
  class inverse_type {
    typedef partial_grid_morphism_aux<GDEF,GIMG,grid_dim_tag<1> > mapping;
