...
STL \xlink{Adaptable Unary Function}{http://www.sgi.com/Technology/STL/AdaptableUnaryFunction.html}
...
\begin{tabularx}{14cm}{llR}  
  ...
  (from \xlink{Adaptable Unary Function}{http://www.sgi.com/Technology/STL/AdaptableUnaryFunction.html})
  \\
  value type  &
  {\tt F::value\_type} &
  synomym for {\tt F::result\_type}   
  \par (from \xlink{Adaptable Unary Function}{http://www.sgi.com/Technology/STL/AdaptableUnaryFunction.html})
  \\ 
  \hline
  \\
\end{tabularx}
...
\xlink{Adaptable Unary Function}{http://www.sgi.com/Technology/STL/AdaptableUnaryFunction.html}
