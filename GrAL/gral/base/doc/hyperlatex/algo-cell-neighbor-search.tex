...
\nmwrcodelink{cell-neighbor-search.h}{Grids/Algorithms}
...
...
\xlink{hash_map.html}{\STLURL/hash_map}<gt::FacetOnCellIterator> , gt::cell_handle> Nbs;
...
the example in  \xlink{{\tt main-triang2d.C}}{\NMWRROOT/test/Grids/triang2d/main-triang2d.C}.

\algosubsection{Known Uses}

Used in \xlink{test}{\NMWRROOT/test/Grids/triang2d/main-triang2d.C}
