...
\begin{tabularx}{14cm}{RlR} 
  ...
  \par model of STL \xlink{Forward iterator}{http://www.sgi.com/Technology/STL/ForwardIterator.html}
  \\ 
  \hline
  \\
\end{tabularx}
...
\begin{tabularx}{15cm}{RRRRR} 
  ...
  {\tt  \xlink{distance}{http://www.sgi.com/Technology/STL/distance.html}(i,f.end()) == f.size()}
  \\ 
  end of value sequence  &
  {\tt i = f.end();} &
  {\tt f} is bound to a grid  &
