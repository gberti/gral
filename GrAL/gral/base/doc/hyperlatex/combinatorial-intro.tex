  ...
  \begin{figure}[h]
    \T\begin{minipage}{6cm}
        ...
        \W\htmlimage[ALT="a grid consisting of 2 adjacent triangles (2 cells, 5 edges, 4 vertices)"]{bilder/cellcx-2triang.gif}
        \caption{A simple grid \ldots}
      \T\end{minipage}  \T\hspace{1cm}
    \T\begin{minipage}{6cm}
        \T\includegraphics[width=5cm]{bilder/cellcx-2triang-lattice.eps} 
        \W\htmlimage[ALT="the lattice of this grid"]{bilder/cellcx-2triang-lattice.gif}
  ...
  \end{Label}
   ...
   \begin{figure}[h]
     \begin{center}
       ...
       \W\htmlimage[ALT="A cell iterator hopping from cell to cell"]{bilder/cell-it.gif}
