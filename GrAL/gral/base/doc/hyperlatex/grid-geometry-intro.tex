...
\begin{tabular}{ll}
  ...
  \hline
  {\tt typedef coord\_type} \sectionlinkUNDEF{GeomCoord}{GeomCoord} & point in space  \\
  {\tt typedef segment\_type} \sectionlinkUNDEF{GeomSegment}{GeomSegment} &  1D segment corr. to {\tt Edge} \\ 
  {\tt typedef polygon\_type} \sectionlinkUNDEF{GeomPolygon}{GeomPolygon}    &  2D polygon corr. to {\tt Face} \\ 
  {\tt typedef polyhedron\_type} \sectionlinkUNDEF{GeomPolyhedron}{GeomPolyhedron} &  3D polyhedron corr. to {\tt Cell} (in 3D Grids)\\
  \hline
