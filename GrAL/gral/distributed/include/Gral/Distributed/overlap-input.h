#ifndef NMWR_GB_OVERLAP_INPUT_H
#define NMWR_GB_OVERLAP_INPUT_H
...
template<class CoarseGrid, class FineGrid, 
         template<class U> class OVLP_RANGES = overlap_range_input>
class overlap_input {
public:
...
private:
  ...
  void set_fine_grid(grid_type const& fg) {
    ...
    neighbour_ranges_v.set_default(v_range_type());
    neighbour_ranges_c.set_default(c_range_type());
  }
...
#include "Gral/Distributed/internal/overlap-input.C"
#endif
